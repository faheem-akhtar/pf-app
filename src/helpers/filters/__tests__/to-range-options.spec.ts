...
describe('arrayFilterNonValue', () => {
  ...
  it('should return values less than or equal to 60000', () => {
    expect(filtersToRangeOptions(options, 60000, true)).toEqual([
      { value: null, label: 'From' },
      { value: 20000, label: '20,000' },
      { value: 30000, label: '30,000' },
      { value: 40000, label: '40,000' },
  ...
  it('should return values higher than or equal to 30000', () => {
    expect(filtersToRangeOptions(options, 30000, false)).toEqual([
      { value: null, label: 'From' },
      { value: 30000, label: '30,000' },
      { value: 40000, label: '40,000' },
      { value: 50000, label: '50,000' },
  ...
  it('should return exact values when the value is null', () => {
    expect(filtersToRangeOptions(options, null, false)).toEqual(options);
  });
});
