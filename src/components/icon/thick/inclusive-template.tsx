...
/**
 * https://www.figma.com/file/BVGglAIgmnat5ZIwihRY9H/PF_Icon-Library?node-id=44%3A1
 */
export const IconThickInclusiveTemplate = (props: IconTemplatePropsInterface): JSX.Element => {
