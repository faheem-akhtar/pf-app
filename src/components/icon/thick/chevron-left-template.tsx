...
/*
 * https://www.figma.com/file/BVGglAIgmnat5ZIwihRY9H/PF_Icon-Library?node-id=7%3A2706
 */
export const IconThickChevronLeftTemplate = (props: IconTemplatePropsInterface): JSX.Element => {
