...
/**
 * https://www.figma.com/file/BVGglAIgmnat5ZIwihRY9H/PF_Icon-Library?node-id=0%3A892
 */
export const IconThickSearchTemplate = (props: IconTemplatePropsInterface): JSX.Element => {
