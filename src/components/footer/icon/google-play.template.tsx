...
export const IconGooglePlayTemplate: FunctionComponent = () => (
  <svg
    width='165'
    height='52'
    viewBox='0 0 165 52'
  ...
  >
    <defs>
      ...
      <path
        d='M1.031 1.418v27.328c0 .774.645 1.418 1.29 1.418.643 0 1.03-.258 1.288-.387l24.88-13.664c.515-.258.773-.644.773-1.03 0-.388-.258-.774-.774-1.032L3.61.387C3.223.129 2.964 0 2.32 0c-.644 0-1.289.645-1.289 1.418'
        id='c'
      />
      <path d='M.773 0l15.082 15.083 4.77-4.642L2.32.387C1.934.129 1.674 0 1.031 0H.773z' id='f' />
      <path
        d='M.387 5.93l4.64 4.64 6.703-3.738c.516-.258.774-.644.774-1.031 0-.387-.258-.774-.774-1.031L5.156 1.16.386 5.93z'
        id='i'
      />
    ...
    <g fill='none' fill-rule='evenodd'>
      <g>
        ...
        <path
          d='M159.844 51.563H5.156C2.32 51.563 0 49.241 0 46.407V5.157C0 2.32 2.32 0 5.156 0h154.688C162.68 0 165 2.32 165 5.157v41.25c0 2.834-2.32 5.156-5.156 5.156'
          fill='#000'
          mask='url(#b)'
        />
      </g>
      <g transform='translate(11.602 10.313)'>
        <mask id='e' fill='#fff'>
          <use xlinkHref='#c' />
        </mask>
        <path
      ...
      <g transform='translate(12.89 10.313)'>
        <mask id='h' fill='#fff'>
          <use xlinkHref='#f' />
        </mask>
        <path
          d='M.773 0l15.082 15.083 4.77-4.642L2.32.387C1.934.129 1.674 0 1.031 0H.773z'
          fill='url(#g)'
          mask='url(#h)'
        />
      </g>
      <g transform='translate(28.36 19.336)'>
        <mask id='k' fill='#fff'>
          <use xlinkHref='#i' />
        </mask>
        <path
      ...
      <g transform='translate(12.89 24.492)'>
        <mask id='n' fill='#fff'>
          <use xlinkHref='#l' />
        </mask>
        <path
          d='M.902 15.727c.13 0 .13 0 0 0 .772 0 1.032-.13 1.418-.387l18.176-9.926-4.64-4.64L.901 15.726z'
          fill='url(#m)'
          mask='url(#n)'
        />
      </g>
