...
(function e(b, g, d) {
...
})(
  {
            ...
            f = {
              ...
              base64ToBytes: function (h) {
                ...
                for (var g = [], j = 0, k = 0; j < h.length; k = ++j % 4) {
                  ...
                  g.push(
                    ((d.indexOf(h.charAt(j - 1)) & (Math.pow(2, -2 * k + 8) - 1)) << (k * 2)) |
      ...
      function (b, d, a) {
        ...
        function c(i) {
          if (i == null) {
            ...
            if (typeof i === 'number') {
              return { type: 'dtm', value: i };
            } else {
              if (i.type === 'ttm') {
                return { type: 'ttm', value: i.value };
              } else {
                return { type: 'dtm', value: i.value || new Date().getTime() };
              }
            }
          }
        }
      ...
      function (g, h, c) {
        ...
        function i(j) {
          return (
            typeof j !== 'undefined' &&
            j !== null &&
            (j.constructor === {}.constructor || j.constructor === [].constructor)
          );
        }
        c.isJson = i;
        function b(k) {
    ...
    13: [
      ...
      { './lib/helpers': 18, './lib_managed/lodash': 20 },
    ],
    14: [
      function (c, d, a) {
        ...
        b.getFormTrackingManager = function (l, k, n) {
          ...
          function p(t) {
            return t[
              g.find(['name', 'id', 'type', 'nodeName'], function (u) {
          ...
          function i(u) {
            ...
            g.forEach(q, function (v) {
              ...
              g.forEach(w, function (y) {
                ...
                var x = { name: p(y), value: y.value, nodeName: y.nodeName };
    ...
    17: [
      function (b, c, a) {
        (function () {
          ...
          i.detectBrowserFeatures = function (p, o) {
            ...
            if (
              d.constructor === window.Navigator &&
              typeof d.javaEnabled !== 'unknown' &&
              !m.isUndefined(d.javaEnabled) &&
              d.javaEnabled()
            ) {
              q.java = '1';
            }
      ...
      { '../lib_managed/lodash': 20, 'browser-cookie-lite': 1, jstimezonedetect: 4, murmurhash: 5 },
    ],
    18: [
      function (b, c, a) {
        (function () {
      ...
      { '../lib_managed/lodash': 20, 'browser-cookie-lite': 1 },
    ],
    19: [
      function (b, c, a) {
        (function () {
      ...
      function (b, c, a) {
        (function (d) {
          (function () {
            ...
            var aO = { function: true, object: true };
            ...
            R[v] = bl.Uint32Array;
            var a4 = {};
            a4[aJ] = a4[E] = a4[o] = { constructor: true, toLocaleString: true, toString: true, valueOf: true };
            a4[a0] = a4[D] = { constructor: true, toString: true, valueOf: true };
            a4[aT] = a4[g] = a4[ab] = { constructor: true, toString: true };
            a4[m] = { constructor: true };
            a5(br, function (bE) {
              for (var bD in a4) {
                if (aF.call(a4, bD)) {
                  var bF = a4[bD];
            ...
            function bk(bT, bF, bQ, bL, bN, bS, bR) {
              ...
              if (!bD) {
                ...
                if (
                  ...
                  'constructor' in bT &&
                  'constructor' in bF &&
                  !(typeof bM == 'function' && bM instanceof bM && typeof bP == 'function' && bP instanceof bP)
                ) {
                  return false;
                }
              }
            ...
            var aa = !by
              ...
              : function (bE) {
                  ...
                  if (
                    (typeof bD == 'function' && bD.prototype === bE) ||
                    (typeof bE == 'function' ? Q.support.enumPrototypes : a1(bE))
                  ) {
                    return ap(bE);
                  }
                  return U(bE) ? by(bE) : [];
            ...
            function a6(bF) {
              ...
              for (var bM in bF) {
                if (
                  !(bQ && bM == 'prototype') &&
                  !(bL && (bM == 'message' || bM == 'name')) &&
                  !(bJ && H(bM, bD)) &&
                  !(bM == 'constructor' && (bG || !aF.call(bF, bM)))
                ) {
                  bR.push(bM);
                }
              }
        ...
        (function () {
          ...
          d.OutQueueManager = function (y, r, t, A, x, n, k) {
            ...
            function B(D) {
              ...
              return { evt: E, bytes: C(JSON.stringify(E)) };
            }
            function C(F) {
              var D = 0;
            ...
            return { enqueueRequest: u, executeQueue: z };
          };
        })();
      },
      { './lib/detectors': 17, './lib/helpers': 18, './lib_managed/lodash': 20 },
    ],
    23: [
      function (b, c, a) {
        (function () {
            ...
            function q() {
              ...
              if (o.expireDateTime) {
                do {
                  t = new Date();
                  if (
                    j.filter(o.outQueues, function (u) {
                      return u.length > 0;
                    }).length === 0
                  ) {
                    break;
      ...
      { './in_queue': 15, './lib/helpers': 18, './lib_managed/lodash': 20, './tracker': 24, uuid: 12 },
    ],
    24: [
      function (b, c, a) {
        (function () {
          ...
          i.Tracker = function k(bw, a3, V, D, aJ) {
            var A = m(true, function (bF) {
              ...
              y,
              bi = aJ.hasOwnProperty('appId') ? aJ.appId : '',
              aD,
              a0 = ax.title,
              E,
              aS = aJ.hasOwnProperty('pageUnloadTimer') ? aJ.pageUnloadTimer : 500,
              Q = false,
              G,
              W,
              H,
              bs = aJ.hasOwnProperty('cookieName') ? aJ.cookieName : '_sp_',
              J = aJ.hasOwnProperty('cookieDomain') ? aJ.cookieDomain : null,
              bt = '/',
              ad = X.doNotTrack || X.msDoNotTrack || al.doNotTrack,
              bm = aJ.hasOwnProperty('respectDoNotTrack')
                ? aJ.respectDoNotTrack && (ad === 'yes' || ad === '1')
                : false,
              av,
              ar,
              N = aJ.hasOwnProperty('cookieLifetime') ? aJ.cookieLifetime : 63072000,
              ...
              aq = aJ.hasOwnProperty('useLocalStorage')
                ? (g.warn('argmap.useLocalStorage is deprecated. Use argmap.stateStorageStrategy instead.'),
                  aJ.useLocalStorage)
                : true,
              aM = aJ.hasOwnProperty('useCookies')
                ? (g.warn('argmap.useCookies is deprecated. Use argmap.stateStorageStrategy instead.'), aJ.useCookies)
                : true,
              aY = aJ.hasOwnProperty('stateStorageStrategy')
                ? aJ.stateStorageStrategy
                : !aM && !aq
                ? 'none'
                : aM && aq
              ...
              aT = p.errorManager(A),
              bo = new l.OutQueueManager(
                bw,
                a3,
                D,
                aY == 'localStorage' || aY == 'cookieAndLocalStorage',
                aJ.post,
                aJ.bufferSize,
                aJ.maxPostBytes || 40000
              ),
              a9 = false,
              bx = aJ.contexts || {},
              bz = [],
            ...
            function bh() {
              return { schema: 'iglu:com.snowplowanalytics.snowplow/web_page/jsonschema/1-0-0', data: { id: aC() } };
            }
            function T() {
              var bF = [
                'navigationStart',
              ...
              if (bI) {
                ...
                return { schema: 'iglu:org.w3/PerformanceTiming/jsonschema/1-0-0', data: bH };
              }
            }
            function B(bH, bF) {
              var bG;
              ...
              if (bI) {
                ...
                for (var bH in bI) {
                  if (bI.hasOwnProperty(bH)) {
                    ...
                    bJ.push({ schema: 'iglu:com.optimizely/experiment/jsonschema/1-0-0', data: bG });
                  }
                }
                return bJ;
              }
            ...
            function s() {
              ...
              if (bH) {
                ...
                for (var bK = 0; bK < bG.length; bK++) {
                  ...
                  bJ.push({ schema: 'iglu:com.optimizely/state/jsonschema/1-0-0', data: bI });
                }
                return bJ;
              }
              return [];
              ...
              if (bI) {
                ...
                for (var bH in bI) {
                  if (bI.hasOwnProperty(bH)) {
                    ...
                    bG.name = bF.name;
                    bG.code = bF.code;
                    bJ.push({ schema: 'iglu:com.optimizely/variation/jsonschema/1-0-0', data: bG });
                  }
                }
                return bJ;
              }
            ...
            function a7() {
              ...
              if (bI) {
                ...
                bH.os = bI.os;
                return { schema: 'iglu:com.optimizely/visitor/jsonschema/1-0-0', data: bH };
              }
            }
            function U() {
              ...
              if (bI) {
                ...
                for (var bG in bI) {
                  if (bI.hasOwnProperty(bG)) {
                    var bF = { id: bG, isMember: bI[bG] };
                    bH.push({ schema: 'iglu:com.optimizely/visitor_audience/jsonschema/1-0-0', data: bF });
                  }
                }
                return bH;
              }
              ...
              if (bF) {
                ...
                for (var bH in bF) {
                  if (bF.hasOwnProperty(bH)) {
                    var bG = { id: bH, value: bF[bH] };
                    bI.push({ schema: 'iglu:com.optimizely/visitor_dimension/jsonschema/1-0-0', data: bG });
                  }
                }
                return bI;
              }
            ...
            function aj() {
              return r.map(bb(), function (bF) {
                return { schema: 'iglu:com.optimizely.snowplow/optimizely_summary/jsonschema/1-0-0', data: bF };
              });
            }
            function a2() {
              return r.map(aa(), function (bF) {
                return { schema: 'iglu:com.optimizely.optimizelyx/summary/jsonschema/1-0-0', data: bF };
              });
            }
            function aG() {
              var bI = al.augur;
              if (bI) {
                var bH = { consumer: {}, device: {} };
                var bG = bI.consumer || {};
                ...
                return { schema: 'iglu:io.augur.snowplow/identity_lite/jsonschema/1-0-0', data: bH };
              }
            }
            function bC() {
              var bH = window._hawk;
              if (bH) {
                var bG = { encryptedId: null, optout: null };
                ...
                return { schema: 'iglu:com.parrable/encrypted_payload/jsonschema/1-0-0', data: bG };
              }
            }
            function bu() {
            ...
            function I() {
              ...
              return { schema: 'iglu:com.google.analytics/cookies/jsonschema/1-0-0', data: bF };
            }
            function aR(bG, bF) {
            ...
            return {
              ...
              trackTrans: function () {
                ae(function () {
                  a5(
                    F.transaction.orderId,
                    F.transaction.affiliation,
                    F.transaction.total,
                    F.transaction.tax,
                    F.transaction.shipping,
                    F.transaction.city,
                    F.transaction.state,
                    F.transaction.country,
                    F.transaction.currency,
                    F.transaction.context,
                    F.transaction.tstamp
                  );
                  ...
                  A.trackSelfDescribingEvent(
                    {
                      ...
                      data: { category: bK, variable: bH, timing: bJ, label: bG },
                    },
                    bp(bI),
                    bF
                  );
              ...
              addEnhancedEcommercePromoContext: function (bJ, bI, bH, bF, bG) {
                u.push({
                  ...
                  data: { id: bJ, name: bI, creative: bH, position: bF, currency: bG },
                });
              },
